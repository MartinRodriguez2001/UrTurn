...
class User {
   ...
   */
  static async create({ email, password, name, role = 'passenger', phone_number, description }) {
    try {
      ...
      const text = `
        INSERT INTO users (email, password, names, isDriver, phone_number, descriptions, created_at, updated_at)
        VALUES ($1, $2, $3, $4, $5, $6, NOW(), NOW())
        RETURNING id, email, names, isDriver, phone_number, descriptions, created_at
      `;
