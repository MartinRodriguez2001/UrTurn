...
export class ReportService {
    async createReport(reportData) {
        try {
            ...
            const isPassenger = travel.confirmations.some((c) => c.usuarioId === reportData.usuarioId);
            ...
            throw new Error(error instanceof Error ? error.message : "Error al crear reporte");
        }
    }
    ...
    async getTravelReports(travelId) {
        try {
            const reports = await prisma.report.findMany({
                where: {
                    travelId: travelId,
    ...
    async deleteReport(reportId, userId) {
        try {
            ...
            throw new Error(error instanceof Error ? error.message : "Error al eliminar reporte");
        }
    }
}
