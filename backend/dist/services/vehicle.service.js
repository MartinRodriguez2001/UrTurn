...
export class VehicleService {
    async forceValidateVehicle(vehicleId, userId) {
        try {
    ...
    async forceInvalidateVehicle(vehicleId, userId) {
        try {
    ...
    async getVehicleById(vehicleId, userId) {
        try {
            ...
            if (!vehicle) {
                throw new Error("Vehículo no encontrado o no tienes permisos para acceder a él");
            }
            return {
                success: true,
                vehicle,
    ...
    async updateVehicle(vehicleId, userId, updateData) {
        try {
            ...
            if (updateData.brand)
                updateFields.brand = updateData.brand;
            if (updateData.year)
