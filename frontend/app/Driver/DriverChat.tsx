        ...
        <View style={styles.section}>
          ...
          {passengers.length ? (
            passengers.map((passenger) => (
              <View key={passenger.id} style={styles.participantRow}>
                {passenger.avatar ? (
                  <Image source={{ uri: passenger.avatar }} style={styles.participantAvatar} />
                ) : (
                ...
                <View style={styles.participantInfo}>
                  <Text style={styles.participantName}>{passenger.name}</Text>
