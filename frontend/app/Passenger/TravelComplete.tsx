...
export default function TravelComplete() {
  ...
  const { travelId, driverName, driverId } = params;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await ReviewApiService.createReview({
        user_target_id: parseInt(driverId as string),
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoValue}>{driverName || "Nombre del conductor"}</Text>
        </View>

        {/* Rating Section */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>¿Cómo fue tu experiencia?</Text>
          <Text style={styles.sectionSubtitle}>Califica a tu conductor</Text>
